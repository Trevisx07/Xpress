...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: 'Recovery',
    short: 'Scene cleanup, winch outs, and transport to the body shop of your choice.',
    long: [
      'After a wreck on I-10, I-65, or the Bayway, job one is getting the vehicle out of the lane and you out of traffic. We work with Mobile Police and ALEA, clear debris, and winch out of ditches and medians. Photos at the scene and at drop off, an itemized invoice your adjuster can read, and you choose the body shop.',
    ],
    bullets: ['Winch outs from ditches, medians, and soft shoulders', 'Debris cleanup coordinated with law enforcement', 'Photo documentation at scene and drop off', 'Transport to the body shop or storage yard you pick', 'Insurance ready itemized invoices'],
    idealFor: 'Anyone in a collision on Mobile area highways, and body shops that need reliable pickup.',
    icon: 'Shield',
    ...
    seoKeywords: ['accident towing Mobile AL', 'wreck recovery Mobile', 'winch out service Mobile'],
  },
  {
    slug: 'roadside-assistance',
    name: 'Roadside Assistance',
    category: 'Roadside',
    short: 'Fuel delivery, tire changes, and minor fixes on the spot.',
    long: [
    ...
    bullets: ['Fuel delivery, gas or diesel', 'Tire change with your spare', 'Short pull outs from sand, mud, or a ditch edge', 'Minor on-site help before deciding on a tow'],
    ...
    seoKeywords: ['roadside assistance Mobile Alabama', 'fuel delivery Mobile AL', 'tire change service Mobile'],
  },
  {
    slug: 'lockouts',
    name: 'Lockouts',
  ...
  },
  {
    ...
    name: 'Jump Starts',
    category: 'Roadside',
    short: 'Battery testing and a safe jump, or a straight answer that you need a tow.',
    long: [
    ...
    seoKeywords: ['jump start service Mobile', 'dead battery help Mobile AL', 'car won\'t start Mobile'],
  },
];
